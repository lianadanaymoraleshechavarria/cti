        ...
        const errorContainer = document.querySelector("#error-container")
                ...
                ['name', 'lastName', 'organismo', 'funcionario', 'carrera'].forEach((id) => {
        ...
        ['name', 'lastName', 'organismo', 'motivo', 'funcionario', 'carrera'].forEach((id) => {
                    var field = document.getElementById(id);
                    if (field) {
                        field.addEventListener('input', function() {
                ...
                ['tomo', 'folio', 'numero', 'ci', 'tel', 'year'].forEach((id) => {
                    var field = document.getElementById(id);
                    if (field) {
                        field.addEventListener('input', function() {
        ...
        const c = (e)=>{
                ...
                if(tipo.value == ""){
                    tipo.style = "border:solid 2px #212d57;"
                    mensaje += `Campo 'Tipo de Trámite' en blanco <br>`
                    e.preventDefault()
                }else{ 
                    tipo.style = "border:solid 2px white;"
                }
                ...
                if(organismo.value == ""){
                    ...
                    organismo.style = "border:solid 2px white;"
                }
                ...
                if(carrera.value == ""){
                    carrera.style = "border:solid 2px #212d57;"
                    mensaje += `Campo 'Carrera' en blanco <br>`
                    e.preventDefault()
                }else{ 
                    carrera.style = "border:solid 2px white;"
                }
            
                if(year.value == "" || isNaN(year.value) || year.value.length != 4 ){
                    year.style = "border:solid 2px #212d57;"
                    mensaje += `Campo 'Año' es incorrecto debe tener 4 dígitos <br>`
                    e.preventDefault()
                }
                else{
